...
extern PID LF_AddPID;  // which=1, 左前(LF), 编码器TIM5, PWM=TIM1 CH3/CH4
extern PID RF_AddPID;  // which=2, 右前(RF), 编码器TIM4, PWM=TIM9 CH1/CH2
extern PID LR_AddPID;  // which=3, 左后(LR), 编码器TIM3, PWM=TIM10 CH1+TIM11 CH1
extern PID RR_AddPID;  // which=4, 右后(RR), 编码器TIM2, PWM=TIM1 CH1/CH2
